...
function ScreenController() {
    ...
    function rebuildTodo(reTodo) {
        let todo = new _todos__WEBPACK_IMPORTED_MODULE_0__["default"](reTodo.title, reTodo.description, reTodo.dueDate, reTodo.priority);
        return todo;
    }

    function rebuildNote(reNote) {
        let note = new _notes__WEBPACK_IMPORTED_MODULE_1__["default"](reNote.title, reNote.description);
        return note;
    }

    function rebuildChecklist(reChecklist) {
        let checks = rebuildChecks(reChecklist.checks);
        let checklist = new _checklists__WEBPACK_IMPORTED_MODULE_2__.Checklist(reChecklist.title, 
    ...
    function rebuildChecks(reChecks) {
        let checks = [];
        reChecks.forEach((c) => {
            const check = new _checklists__WEBPACK_IMPORTED_MODULE_2__.Check(c.description);
            checks.push(check);
        });
        return checks;
    }

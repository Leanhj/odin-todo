...
function ScreenController() {
    ...
    function retrieveStorage() {
        ...
        wrapper = new _projects__WEBPACK_IMPORTED_MODULE_3__.ProjectWrapper();
        savedWrapper['projects'].forEach(p => {
            const project = new _projects__WEBPACK_IMPORTED_MODULE_3__.Project(p.name);
